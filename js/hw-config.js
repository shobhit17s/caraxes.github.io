...
(function (HW) {
  ...
  HW.CASE_STUDY_URL = 'case-study/index.html';
  ...
  HW.WORLDS = [
    ...
    },
    {
      ...
      spin: 0.17,
      props: [
        { src: 'props/work-pavilion.svg',  lat: 24,  lon: 0,   size: 0.85,
          href: HW.CASE_STUDY_URL, label: 'Industry Dashboard \u2014 the whole story' },
        { src: 'props/work-easel.svg',     lat: -6,  lon: 52,  size: 0.55,
          href: HW.CASE_STUDY_URL + '#cs-slide-7', label: 'Conducting research' },
        { src: 'props/work-pavilion.svg',  lat: 38,  lon: 103, size: 0.6,
          href: HW.CASE_STUDY_URL + '#cs-slide-persona', label: 'Who we designed for' },
        { src: 'props/work-pavilion.svg',  lat: -22, lon: 154, size: 0.5,
          href: HW.CASE_STUDY_URL + '#cs-slide-wireframe', label: 'The wireframes' },
        { src: 'props/work-easel.svg',     lat: 12,  lon: 206, size: 0.42,
          href: HW.CASE_STUDY_URL + '#cs-slide-backend', label: 'Under the hood' },
        { src: 'props/work-pavilion.svg',  lat: -10, lon: 257, size: 0.44,
          href: HW.CASE_STUDY_URL + '#cs-slide-19', label: 'The final product' },
        { src: 'props/work-flagstack.svg', lat: 32,  lon: 309, size: 0.42 }
      ],
      food: [
